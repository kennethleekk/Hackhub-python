...
class Hackhub(db.Model):
    __tablename__ = 'hackhub'
    ...
    teammember1 = db.Column(db.String(255))
    teammember2 = db.Column(db.String(255))
    teammember3 = db.Column(db.String(255))
    teammember4 = db.Column(db.String(255))
    teammember5 = db.Column(db.String(255))
    teammember6 = db.Column(db.String(255))
    teammember7 = db.Column(db.String(255))
    teammember8 = db.Column(db.String(255))
    teammember9 = db.Column(db.String(255))
    teammemberemail1 = db.Column(db.String(255))
    teammemberemail2 = db.Column(db.String(255))
    teammemberemail3 = db.Column(db.String(255))
    teammemberemail4 = db.Column(db.String(255))
    teammemberemail5 = db.Column(db.String(255))
    teammemberemail6 = db.Column(db.String(255))
    teammemberemail7 = db.Column(db.String(255))
    teammemberemail8 = db.Column(db.String(255))
    teammemberemail9 = db.Column(db.String(255))
    createdBy = db.Column(db.String(255))
    createdById = db.Column(db.String(255))
    githubUrl = db.Column(db.String(255))
    confluenceUrl = db.Column(db.String(255))
    jiraUrl = db.Column(db.String(255))
    purpose = db.Column(db.String(4096), nullable=False)
    publisheddate = db.Column(db.String(255))
    businessfunction = db.Column(db.String(255))
    version = db.Column(db.String(255))
    serviceline = db.Column(db.String(255))
    attachmentname1 = db.Column(db.String(255))
    attachmenturl1 = db.Column(db.String(255))
    attachmentname2 = db.Column(db.String(255))
    attachmenturl2 = db.Column(db.String(255))
    attachmentname3 = db.Column(db.String(255))
    attachmenturl3 = db.Column(db.String(255))
    attachmentname4 = db.Column(db.String(255))
    attachmenturl4 = db.Column(db.String(255))
    attachmentname5 = db.Column(db.String(255))
    attachmenturl5 = db.Column(db.String(255))
    attachmentname6 = db.Column(db.String(255))
    attachmenturl6 = db.Column(db.String(255))
    attachmentname7 = db.Column(db.String(255))
    attachmenturl7 = db.Column(db.String(255))
    attachmentname8 = db.Column(db.String(255))
    attachmenturl8 = db.Column(db.String(255))
    attachmentname9 = db.Column(db.String(255))
    attachmenturl9 = db.Column(db.String(255))
    hackathonName = db.Column(db.String(255))
...
def getAppList():
    ...
    books = builtin_list(map(from_sql_removeappid, query.all()))
    return (books)
...
def getHackhubList():
    fields = ['id','title','category','teamname','symbol','keywords','hackathonName']
    query = (Hackhub.query.options(load_only(*fields)).order_by(Hackhub.id))
    
    data = builtin_list(map(from_sql, query.all()))
    return (data)

def getHackhubDetail(id):
    query = (Hackhub.query.filter_by(id=id))
    data = builtin_list(map(from_sql, query.all()))
    return (data)

def createHackhub(data):
    hackhub = Hackhub(**data)
    db.session.add(hackhub)
    db.session.commit()
    return from_sql(hackhub)

def deleteHackhub(id):
    Hackhub.query.filter_by(id=id).delete()
    db.session.commit()
    return "OK"

def updateHackhub(data):
    hackhub = Hackhub.query.get(data['id'])
    for k, v in data.items():
        setattr(hackhub, k, v)
    db.session.commit()
    return from_sql(hackhub)
