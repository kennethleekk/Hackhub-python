...
PROJECT_ID = 'hackhub-001'

# CloudSQL & SQLAlchemy configuration
# Replace the following values the respective values of your Cloud SQL
# instance.
CLOUDSQL_USER = 'eep'
CLOUDSQL_PASSWORD = 'en8iFijzwkBMhfGf'
CLOUDSQL_DATABASE = 'bookshelf'
# Set this value to the Cloud SQL connection name, e.g.
#   "project:region:cloudsql-instance".
# You must also update the value in app.yaml.
CLOUDSQL_CONNECTION_NAME = 'hackhub-001:us-east1:library'
...
CLOUD_STORAGE_BUCKET = 'hackhub-001'
MAX_CONTENT_LENGTH = 1024 * 1024 * 1024
ALLOWED_EXTENSIONS = set(['png', 'jpg', 'jpeg', 'gif', 'mp4', 'zip', 'pptx', 'doc', 'docx', 'ppt','pdf', 'txt'])
...
GOOGLE_OAUTH2_CLIENT_ID = \
    '163612466577-lkbl3s9occal16845pj684jpj33huf8m.apps.googleusercontent.com'
GOOGLE_OAUTH2_CLIENT_SECRET = '5AtxJ6rPjmGfzQ-lqpVHAIzD'
